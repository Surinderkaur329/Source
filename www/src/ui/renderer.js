...
LetiFramework.Renderer.initialize = function() {
	...
	this.game.state.add("Menu2", LetiFramework.Ui.menu2);
	this.game.state.add("Menu3", LetiFramework.Ui.menu3);
	this.game.state.add("SubMenu", LetiFramework.Ui.submenu);
	this.game.state.add("About", LetiFramework.Ui.about);
	this.game.state.add("Contact", LetiFramework.Ui.contact);
	...
	this.game.state.add("Register3", LetiFramework.Ui.register3);
	...
	this.game.state.add("Preloader", LetiFramework.Ui.preloader);
	this.game.state.add("Background", LetiFramework.Ui.Background);
	this.game.state.add("Purchase", LetiFramework.Ui.purchase);
