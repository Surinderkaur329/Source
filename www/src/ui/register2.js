...
LetiFramework.Ui.register2.prototype = {
  ...
  showCurrentField: function() {
    ...
    if(this.screenConfig.cancel_button.type === "button") {
      this.cancelBt.setText(currentFieldConfig.cancel_button_text || this.screenConfig.cancel_button.text);
    }
  ...
  nicknameHandler: function() {
    ...
    stores.set("prevScreen", "Register2");
  ...
  registerHandler: function() {
    ...
    var user = new LetiFramework.DbEntities.User(stores.get("nickname"));
  ...
  registerSuccessHandler: function(user) {    
    ...
    LetiFramework.Db.create("users", user); // save user
