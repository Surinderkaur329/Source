...
LetiFramework.Ui.decision.prototype = {
            ...
            if (decision.text.length > 0) {
                ...
                if (decision.custom_font) {
                    ...
                    this.decisionText = this.game.add.bitmapText(
                        ...
                        LetiFramework.Utils.getAssetFontPath(cf), LetiFramework.Utils.wrapText(decision.text, cf), cf.font_size);
                } else {
    ...
    transitionPage: function() {
        ...
        var pas = this.decisions[this.selectedChoice].player_attributes;
        if (pas) {
            for (var k in pas) {
                this.currentUser.player_attributes[k] += pas[k];
            }
            ...
            if (showBadge) {
                ...
                if (alreadyEarned) {
                    ...
                    if (rs.length > 0) {
                        ...
                        this.badgeDialog = new LetiFramework.Ui.BadgeDialog(this.game, decisionBadge, true);
                        this.badgeDialog.show();
                    } else {
                        LetiFramework.GameController.nextPage();
                    }
