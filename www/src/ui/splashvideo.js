...
LetiFramework.Ui.splashvideo.prototype = {
	...
	preload: function() {
		...
		LetiFramework.Utils.loadImage(this.screenConfig.image);			
	},
	create: function() {
	...
	showImage: function() {
		...
		this.bg = this.game.add.sprite(this.game.world.centerX, this.game.world.centerY, LetiFramework.Utils.getImagePath(this.screenConfig.image));
