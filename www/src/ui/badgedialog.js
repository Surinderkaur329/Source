...
LetiFramework.Ui.BadgeDialog = function(game, badge, close) {
	this.game = game;
	...
	var dialogBg = this.createDialogImage(
		LetiFramework.Utils.getImagePath(this.badgeStyle.background), this.badgeStyle.bg_scale);
    ...
    var closeBt = null;
    if(close || this.badgeStyle.close_button.hidden != true) {
...
LetiFramework.Ui.BadgeDialog.prototype.createDialogItem = function(itemConfig) {
    ...
    if(itemConfig.type == "text") {
    	...
    	dialogItem = this.createDialogImage(LetiFramework.Utils.getImagePath(itemConfig.image), itemConfig.image_scale);
    }
