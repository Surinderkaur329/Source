...
PurchasePopup.prototype = Object.assign (Object.create (Phaser.Sprite.prototype), {
    init: function () {
        ...
        this.panel.scale.setTo(0.5 * this.game.width / this.overlay.width, 0.5 * this.game.height / this.overlay.height);
    ...
    onresize: function () {
        ...
        var divWidth = 0.35 * scaleManager.width;
        var divHeight = 0.06 * scaleManager.height;
        ...
        this.divCont.style.top = (scaleManager.bounds.y + scaleManager.height * 0.47) + 'px';
    },
